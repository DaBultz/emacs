...
#s(hash-table size 65 test equal rehash-size 1.5 rehash-threshold 0.8125 data ("straight" ("2020-06-07 14:04:30" ("emacs") (:type git :host github :repo "raxod502/straight.el" :files ("straight*.el") :branch "master" :package "straight" :local-repo "straight.el")) "org-elpa" ("2020-06-07 14:04:30" nil (:local-repo nil :package "org-elpa" :type git)) "melpa" ("2020-06-07 14:04:30" nil (:type git :host github :repo "melpa/melpa" :no-build t :package "melpa" :local-repo "melpa")) "gnu-elpa-mirror" ("2020-06-07 14:04:30" nil (:type git :host github :repo "emacs-straight/gnu-elpa-mirror" :no-build t :package "gnu-elpa-mirror" :local-repo "gnu-elpa-mirror")) "emacsmirror-mirror" ("2020-06-07 14:04:30" nil (:type git :host github :repo "emacs-straight/emacsmirror-mirror" :no-build t :package "emacsmirror-mirror" :local-repo "emacsmirror-mirror")) "evil" ("2020-06-07 14:04:30" ("emacs" "undo-tree" "goto-chg" "cl-lib") (:type git :flavor melpa :files (:defaults "doc/build/texinfo/evil.texi" (:exclude "evil-test-helpers.el") "evil-pkg.el") :host github :repo "emacs-evil/evil" :package "evil" :local-repo "evil")) "undo-tree" ("2020-06-07 14:04:30" nil (:type git :host github :repo "emacs-straight/undo-tree" :files ("*" (:exclude ".git")) :package "undo-tree" :local-repo "undo-tree")) "goto-chg" ("2020-06-07 14:04:30" ("undo-tree") (:type git :flavor melpa :host github :repo "emacs-evil/goto-chg" :package "goto-chg" :local-repo "goto-chg")) "gruvbox-theme" ("2020-06-07 14:04:30" ("autothemer") (:type git :flavor melpa :host github :repo "greduan/emacs-theme-gruvbox" :package "gruvbox-theme" :local-repo "emacs-theme-gruvbox")) "autothemer" ("2020-06-07 14:04:30" ("dash" "emacs" "cl-lib") (:type git :flavor melpa :host github :repo "jasonm23/autothemer" :package "autothemer" :local-repo "autothemer")) "dash" ("2020-06-07 14:04:30" nil (:type git :flavor melpa :files ("dash.el" "dash.texi" "dash-pkg.el") :host github :repo "magnars/dash.el" :package "dash" :local-repo "dash.el")) "use-package" ("2020-06-07 14:04:30" ("emacs" "bind-key") (:type git :flavor melpa :files (:defaults (:exclude "bind-key.el" "bind-chord.el" "use-package-chords.el" "use-package-ensure-system-package.el") "use-package-pkg.el") :host github :repo "jwiegley/use-package" :package "use-package" :local-repo "use-package")) "bind-key" ("2020-06-07 14:04:30" nil (:flavor melpa :files ("bind-key.el" "bind-key-pkg.el") :package "bind-key" :local-repo "use-package" :type git :repo "jwiegley/use-package" :host github)) "doom-modeline" ("2020-06-07 14:04:30" ("emacs" "all-the-icons" "shrink-path" "dash") (:type git :flavor melpa :host github :repo "seagle0128/doom-modeline" :package "doom-modeline" :local-repo "doom-modeline")) "all-the-icons" ("2020-06-07 14:04:30" ("emacs" "memoize") (:type git :flavor melpa :files (:defaults "data" "all-the-icons-pkg.el") :host github :repo "domtronn/all-the-icons.el" :package "all-the-icons" :local-repo "all-the-icons.el")) "memoize" ("2020-06-07 14:04:30" nil (:type git :flavor melpa :host github :repo "skeeto/emacs-memoize" :package "memoize" :local-repo "emacs-memoize")) "shrink-path" ("2020-06-07 14:04:30" ("emacs" "s" "dash" "f") (:type git :flavor melpa :host gitlab :repo "bennya/shrink-path.el" :package "shrink-path" :local-repo "shrink-path.el")) "s" ("2020-06-07 14:04:30" nil (:type git :flavor melpa :files ("s.el" "s-pkg.el") :host github :repo "magnars/s.el" :package "s" :local-repo "s.el")) "f" ("2020-06-07 14:04:30" ("s" "dash") (:type git :flavor melpa :files ("f.el" "f-pkg.el") :host github :repo "rejeep/f.el" :package "f" :local-repo "f.el"))))
...
(fn)" t nil) (if (fboundp (quote register-definition-prefixes)) (register-definition-prefixes "use-package-lint" (quote ("use-package-lint-declaration")))) (provide (quote use-package-autoloads))) "memoize" ((memoize memoize-autoloads) (if (fboundp (quote register-definition-prefixes)) (register-definition-prefixes "memoize" (quote ("defmemoize" "memoize")))) (provide (quote memoize-autoloads))) "all-the-icons" ((all-the-icons all-the-icons-faces all-the-icons-autoloads) (autoload (quote all-the-icons-icon-for-dir) "all-the-icons" "Get the formatted icon for DIR.
...
(fn)" nil nil) (autoload (quote doom-modeline-set-message-modeline) "doom-modeline" "Set message mode-line.

(fn)" nil nil) (autoload (quote doom-modeline-set-pdf-modeline) "doom-modeline" "Set pdf mode-line.

(fn)" nil nil) (autoload (quote doom-modeline-set-org-src-modeline) "doom-modeline" "Set org-src mode-line.

(fn)" nil nil) (autoload (quote doom-modeline-set-helm-modeline) "doom-modeline" "Set helm mode-line.

(fn &rest _)" nil nil) (autoload (quote doom-modeline-set-timemachine-modeline) "doom-modeline" "Set timemachine mode-line.
...
(fn &optional ARG)" t nil) (if (fboundp (quote register-definition-prefixes)) (register-definition-prefixes "doom-modeline" (quote ("doom-modeline-")))) (if (fboundp (quote register-definition-prefixes)) (register-definition-prefixes "doom-modeline-core" (quote ("doom-modeline")))) (autoload (quote doom-modeline-env-setup-python) "doom-modeline-env") (autoload (quote doom-modeline-env-setup-ruby) "doom-modeline-env") (autoload (quote doom-modeline-env-setup-perl) "doom-modeline-env") (autoload (quote doom-modeline-env-setup-go) "doom-modeline-env") (autoload (quote doom-modeline-env-setup-elixir) "doom-modeline-env") (autoload (quote doom-modeline-env-setup-rust) "doom-modeline-env") (if (fboundp (quote register-definition-prefixes)) (register-definition-prefixes "doom-modeline-env" (quote ("doom-modeline-")))) (if (fboundp (quote register-definition-prefixes)) (register-definition-prefixes "doom-modeline-segments" (quote ("doom-modeline-")))) (provide (quote doom-modeline-autoloads)))))

#s(hash-table size 65 test eq rehash-size 1.5 rehash-threshold 0.8125 data (org-elpa #s(hash-table size 65 test equal rehash-size 1.5 rehash-threshold 0.8125 data (version 1 "melpa" nil "gnu-elpa-mirror" nil "emacsmirror-mirror" nil "straight" nil "evil" nil "undo-tree" nil "goto-chg" nil "cl-lib" nil "gruvbox-theme" nil "autothemer" nil "dash" nil "use-package" nil "bind-key" nil "doom-modeline" nil "all-the-icons" nil "memoize" nil "shrink-path" nil "s" nil "f" nil)) melpa #s(hash-table size 65 test equal rehash-size 1.5 rehash-threshold 0.8125 data (version 2 "gnu-elpa-mirror" nil "emacsmirror-mirror" nil "straight" nil "evil" (evil :type git :flavor melpa :files (:defaults "doc/build/texinfo/evil.texi" (:exclude "evil-test-helpers.el") "evil-pkg.el") :host github :repo "emacs-evil/evil") "undo-tree" nil "goto-chg" (goto-chg :type git :flavor melpa :host github :repo "emacs-evil/goto-chg") "cl-lib" nil "gruvbox-theme" (gruvbox-theme :type git :flavor melpa :host github :repo "greduan/emacs-theme-gruvbox") "autothemer" (autothemer :type git :flavor melpa :host github :repo "jasonm23/autothemer") "dash" (dash :type git :flavor melpa :files ("dash.el" "dash.texi" "dash-pkg.el") :host github :repo "magnars/dash.el") "use-package" (use-package :type git :flavor melpa :files (:defaults (:exclude "bind-key.el" "bind-chord.el" "use-package-chords.el" "use-package-ensure-system-package.el") "use-package-pkg.el") :host github :repo "jwiegley/use-package") "bind-key" (bind-key :type git :flavor melpa :files ("bind-key.el" "bind-key-pkg.el") :host github :repo "jwiegley/use-package") "doom-modeline" (doom-modeline :type git :flavor melpa :host github :repo "seagle0128/doom-modeline") "all-the-icons" (all-the-icons :type git :flavor melpa :files (:defaults "data" "all-the-icons-pkg.el") :host github :repo "domtronn/all-the-icons.el") "memoize" (memoize :type git :flavor melpa :host github :repo "skeeto/emacs-memoize") "shrink-path" (shrink-path :type git :flavor melpa :host gitlab :repo "bennya/shrink-path.el") "s" (s :type git :flavor melpa :files ("s.el" "s-pkg.el") :host github :repo "magnars/s.el") "f" (f :type git :flavor melpa :files ("f.el" "f-pkg.el") :host github :repo "rejeep/f.el"))) gnu-elpa-mirror #s(hash-table size 65 test equal rehash-size 1.5 rehash-threshold 0.8125 data (version 3 "emacsmirror-mirror" nil "straight" nil "undo-tree" (undo-tree :type git :host github :repo "emacs-straight/undo-tree" :files ("*" (:exclude ".git"))) "cl-lib" nil)) emacsmirror-mirror #s(hash-table size 65 test equal rehash-size 1.5 rehash-threshold 0.8125 data (version 2 "straight" (straight :type git :host github :repo "emacsmirror/straight") "cl-lib" nil))))

("org-elpa" "melpa" "gnu-elpa-mirror" "emacsmirror-mirror" "straight" "emacs" "use-package" "bind-key" "gruvbox-theme" "autothemer" "dash" "cl-lib" "all-the-icons" "memoize" "doom-modeline" "shrink-path" "s" "f" "evil" "undo-tree" "goto-chg")
